...
> [!info] 约定
> 这里使用了 OpenGL 采用的列向量/右手坐标系/欧拉角 XYZ 顺规
...
![[Math/3D数学/公式推导/Untitled Diagram.svg]]
俯仰角 $P$ 是已知的，设黄色向量的值为$1$
...
再利用偏航角 $y$ 来求一下黄色向量的 $x,z$，也就是图中绿色段和白色段

![img](v2-447cf8767b7623fde4da0696a214eb36_r.jpg)

已知偏航角 y 和刚刚求出来的蓝色向量 $cosp$

所以黄色向量的 $x=siny*cosp，z=cosy*cosp$
