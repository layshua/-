...
为了解决这个问题，Welsh 对此进行了改进 [[4 PBR 核心理论和原理]] ( http://page.mi.fu-berlin.de/block/htw-lehre/wise2015_2016/bel_und_rend/skripte/welsh2004.pdf )：
...
## 物体细节的尺度
在毛星云的这篇文章中，提到了**三个尺度**：
![[技术美术/7 PBR/PBR白皮书/content/4 法线分布函数/README#一、基于物理的渲染理念：从宏观表现到微观细节]]
