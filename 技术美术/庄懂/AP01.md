...
# 第11课 代码格式
## 面板
![[Pasted image 20221018211122.png]]
texture3d: (1)2d的序列组（2）3d纹理
![[Pasted image 20221018211148.png]]
![[Pasted image 20221018211208.png]]
## 参数
![[Pasted image 20221018211453.png]]
![[Pasted image 20221018211704.png]]
## IVO
![[Pasted image 20221018211718.png]]
![[Pasted image 20221018211727.png]]
![[Pasted image 20221018211739.png]]
以上注意版本的不同，函数可能不一样。
```less
o.uv = v.uv //这种写法纹理的offset tilling不起作用
o.uv = TRANSFORM_TEX(v.uv,_MainTex);  //起作用，一般不用
```
...
## 库
新建文件: XXX.cgnic
unity内无法直接创建，可以使用IDE创建

在shader中使用： # include “路径” 
...
```
## AD：Addtive
透明度叠加:在AB代码基础上改用Blend One One，视觉上就是提亮
建议用bloom替代
