...
**1. 生成解决方案（用于排除语法错误）：**ctrl+shift+B

**2. 自动排版：**ctrl+K+D（K快速D对齐）

**3. 快速注释：**ctrl+K+C  取消K+U
...
![image-20220623144607182](image-20220623144607182.png)
...
![image-20220623145144291](image-20220623145144291.png)
...
int n1 = 1;
int n2 = 2;
Console.WriteLine($"第一个数字是{n1},第二个是{n2}");
~~~
...
string name = Console.ReadLine(); //只能用string接收
