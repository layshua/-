...
今天在尝试自己写 postprocessing 时，发现使用 texcoord 对_BlitTexture 采样时无法得到正确的结果，代码如下：我直接使用的是 URP 自带的 "Packages/com. unity. render-pipelines. universal/Shaders/PostProcessing/Common. hlsl" 中的一些函数和变量。
