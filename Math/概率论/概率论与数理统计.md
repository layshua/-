...
---
性质：$\displaystyle 当 X\sim N(\mu,\sigma^2)时,\frac{X-\mu}{\sigma}\sim N(0,1)$


$\displaystyle 当 X\sim N(\mu,\sigma^2)时$, 对于任意实数 $a$,有

$\displaystyle F_X(a)=P(X\le a)=P(\frac{X-\mu}{\sigma}\le\frac{a-\mu}{\sigma})=\Phi(\frac{a-\mu}{\sigma}).$