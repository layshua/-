...
- **Plugins** 文件夹搜索 `B_ShooterBotSpawner` 蓝图。这是你更改生成的机器人数量所需编辑的蓝图。
- 在 **团队（Teams）** 分段下，找到字段 **要创建的机器人数量（Num Bots to Create）** ，改为 0 防干扰。
...
1.  ![[Pasted image 20230930212418.png]] 右键 uproject 创建 sln
2. 如果你的项目在 `<PROJECT_DIRECTORY>/Source` 目录中还没有 `<PROJECT_NAME>Server.Target.cs` ，请创建一个。
    *   如需示例，请参阅 `LyraServer.Target.cs` 。
3.  将 **解决方案配置（Solution Configuration）** 更改为 **开发服务器（Development Server）** 。![[Pasted image 20230930212635.png]]
4. 在菜单栏选择 **构建（Build）> 构建解决方案（Build Solution）** 。这样会为你的项目构建专用服务器。
5.  构建过程成功完成后，你可以在 `<PROJECT_DIRECTORY>/Binaries/Win64` 中找到新构建的文件，尤其是可执行文件 `<PROJECT_NAME>Server.exe` 。
...
[![[fa2c5e1fe3f0925f57d69eb1b1c52692_MD5.jpg]]](https://docs.unrealengine.com/5.2/Images/making-interactive-experiences/network-multiplayer/tutorials/DedicatedServers/build-client.png)
...
[![[95d92c98ae7e0e64a5cc2a60076272e9_MD5.jpg]]](https://docs.unrealengine.com/5.2/Images/making-interactive-experiences/network-multiplayer/tutorials/DedicatedServers/cook-content.png)
...
[![[905f31067c55000bdeaa04043ccd3563_MD5.jpg]]](https://docs.unrealengine.com/5.2/Images/making-interactive-experiences/network-multiplayer/tutorials/DedicatedServers/lyra-server-log.png)
...
[![[c73f0fdc6eea04125940608c83cadbdd_MD5.jpg]]](https://docs.unrealengine.com/5.2/Images/making-interactive-experiences/network-multiplayer/tutorials/DedicatedServers/lyra-red-solo.png)
...
[![[745503d1619813d0c58138bfb2ccf961_MD5.jpg]]](https://docs.unrealengine.com/5.2/Images/making-interactive-experiences/network-multiplayer/tutorials/DedicatedServers/lyra-blue-red.png)
