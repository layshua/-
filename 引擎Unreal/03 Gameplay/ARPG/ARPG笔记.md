...
在角色蓝图中创建自定义事件
![[Pasted image 20230925223918.png|750]]
>红框处名字要和上面设置的 Warp Target Name 一致

添加动画通知，在动画蓝图中触发上述自定义事件
![[Pasted image 20230925225937.png]]
>可以加多个更新通知，这样灵活的追踪玩家位置
![[Pasted image 20230925224820.png|650]]

也可以不加通知，用函数在 Tick 中更新
# 声音
## 旧方法
