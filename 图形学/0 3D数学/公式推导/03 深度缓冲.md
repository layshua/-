...
$z''$ 值范围为 $[-1,1]$ ，而 ZBuffer 中存储的值应该为 $[0,1]$，所以我们将 NDC 空间的 Z 值范围转换到 $[0,1]$：（$depth$ 与 $\frac{1}{z}$ 相关，是非线性的，即**非线性深度**）
$$depth = z''\times0.5+0.5=\frac{n}{{n-f}}-\frac{nf}{(n-f)z}\tag{2}$$
