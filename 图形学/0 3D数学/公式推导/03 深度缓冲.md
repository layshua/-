...
然后进行**齐次除法**转换到**NDC 空间**，$\displaystyle z''=\frac{z'}{w'}=(\frac{n+f}{n-f})-\frac{2nf}{(n-f)z}$

$z''$ 值范围为 $[-1,1]$ ，而 ZBuffer 中存储的值应该为 $[0,1]$，所以我们将 NDC 空间的 Z 值范围转换到 $[0,1]$：
$$depth = z''\times0.5+0.5$$
![[Pasted image 20230708123657.png]]
>范围转换前后对比，横轴为 z 值
