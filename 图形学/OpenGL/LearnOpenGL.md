...
![img](vertex_attribute_pointer_interleaved.png)
...
![img](filter_nearest.png)

**GL_LINEAR（也叫线性过滤，(Bi)linear Filtering）它会基于纹理坐标附近的纹理像素，计算出一个插值，近似出这些纹理像素之间的颜色。**一个纹理像素的中心距离纹理坐标越近，那么这个纹理像素的颜色对最终的样本颜色的贡献越大。下图中你可以看到返回的颜色是邻近像素的混合色：

![img](filter_linear.png)
...
![img](vertex_attribute_pointer_interleaved_textures.png)
...
>
> ![coordinate_systems_right_handed](coordinate_systems_right_handed.png)
>
...
![coordinate_systems_result](coordinate_systems_result.png)
...
![image-20220915201926169](image-20220915201926169.png)
...
![img](v2-97cdb45449dd0e831c22a87b0171e7c1_r.jpg)

再利用偏航角y来求一下黄色向量的x、z，也就是图中绿色段和白色段

![img](v2-447cf8767b7623fde4da0696a214eb36_r.jpg)

已知偏航角y和刚刚求出来的cosp

所以黄色向量的x=siny*cosp、z=cosy*cosp

![img](v2-b12cc179c00a5d6ca31f6b97c8b91f39_r.jpg)
...
![img](basic_lighting_diffuse.png)
...
![img](basic_lighting_normal_transformation.png)
...
>
> ![img](v2-2dbc0e75189c8f9f3a549119939a8723_1440w.jpg)
...
![img](basic_lighting_specular.png)
...
![img](materials_with_material.png)
...
![img](materials_specular_map.png)
...
![img](lighting_maps_exercise4.png)
...
![img](light_casters_directional_light.png)
...
![image-20220917143026145](image-20220917143026145.png)
...
![img](light_casters_point_light.png)
...
![img](light_casters_spotlight_hard.png)
...
![image-20220917153358683](image-20220917153358683.png)
...
![img](light_casters_spotlight.png)
...
![img](multiple_lights_combined.png)
...
![img](depth_testing_func_always.png)

将它重新设置为GL_LESS，这会将场景还原为原有的样子：

![img](depth_testing_func_less.png)
...
![image-20220927194448423](image-20220927194448423.png)
...
![image-20220927194511670](image-20220927194511670.png)
...
![img](depth_non_linear_graph.png)
...
![img](depth_testing_visible_depth.png)
...
![img](depth_testing_z_fighting.png)
...
![img](stencil_object_outlining.png)
...
![img](blending_transparent_window.png)
...
![image-20220927202954188](image-20220927202954188.png)
...
![image-20220927203008812](image-20220927203008812.png)

结果就是重叠方形的片段包含了一个60%绿色，40%红色的一种脏兮兮的颜色：

![img](blending_equation_mixed.png)

最终的颜色将会被储存到颜色缓冲中，替代之前的颜色。

这样子很不错，但我们该如何让OpenGL使用这样的因子呢？正好有一个专门的函数，叫做`glBlendFunc`。

`glBlendFunc(GLenum sfactor, GLenum dfactor)`函数接受两个参数，来设置源和目标因子。OpenGL为我们定义了很多个选项，我们将在下面列出大部分最常用的选项。注意常数颜色向量![image-20220927210306459](image-20220927210306459.png)可以通过`glBlendColor`函数来另外设置。
...
![image-20220927203053134](image-20220927203053134.png)
...
![img](blending_incorrect_order.png)
...
![img](faceculling_windingorder.png)
...
![img](framebuffers_screen_texture.png)
...
![img](framebuffers_grayscale.png)
...
![image-20220927212556962](image-20220927212556962.png)
...
![image-20220927212611407](image-20220927212611407.png)
...
![image-20220927212622832](image-20220927212622832.png)

这个核高亮了所有的边缘，而暗化了其它部分，在我们只关心图像的边角的时候是非常有用的。

![img](framebuffers_edge_detection.png)
...
![img](cubemaps_skybox_result.png)
...
![img](cubemaps_reflection_theory.png)
...
![img](cubemaps_reflection_nanosuit.png)
...
![img](cubemaps_refraction_theory.png)
...
![[074f17aaf47d4fe7654247f340c74103_MD5.png]]
...
![[eab55a31c8a6a43cef14e4d56b2210de_MD5.png]]
...
![[faf50c6e6152b87c601e8dd8ab8723db_MD5.png]]
...
![[1c1b176bba5383b543154f60b183c081_MD5.png]]
...
![[ecc47098b868f5050024e98d984ec458_MD5.png]]
...
![[d7c183df267ab8884e8278588fca1ebd_MD5.png]]
...
![[ae2eda5bd40326dd4f55b81bc8664920_MD5.png]]
...
![[4baa2fd84346fc6abebc0ca554383df5_MD5.png]]
...
![[cffd9e01b487dcf048b4ac1a8cc11162_MD5.png]]
...
![[796b496f4f67bec9226f85f8c3de61ad_MD5.png]]
...
![[141cfb53d59d8e3ee740d0306abd2d58_MD5.png]]
...
![[d9a1484e38d71a59b41e8f34e8aa5906_MD5.png]]
...
![[f5207b4f73dbadb6514382a53b7f33b8_MD5.png]]
...
![[5ff05169a1b62c873b068882e779ab3b_MD5.png]]
...
![[791e2a298d81ad1054592365097b9128_MD5.png]]
...
![[d7e996b08d53cd7c37a13324043dd0de_MD5.png]]

可能不是非常明显，但如果你离近仔细观察立方体的边缘，你就应该能够看到锯齿状的图案。如果放大的话，你会看到下面的图案：

![[82516b023b1b0226f660f860db4e4dc1_MD5.png]]
...
![[15ac2bd64b2bb6cbf797d15350d08923_MD5.png]]
...
![[30e53c727214e45446f79ca88554a041_MD5.png]]
...
![[131cda125caafef0b84a47a9607e2044_MD5.png]]
...
![[edec1db30c43203c976f5a90b3a1708c_MD5.png]]
...
![[f76d524dad2ac0bd5a0be47f902ab694_MD5.png]]
...
![[c07fafca7ca803e093a95aa1d4f1cd04_MD5.png]]
...
![[2aa531f57844bfc8cbc5c8d0f639ddde_MD5.png]]
...
![[f294152517e752643473d5f097afe910_MD5.png]]
...
![[697bcb39e986f85172d42963b5c913ca_MD5.png]]
...
![[9d7bdd8db737d6e1a46b888efcfe70d5_MD5.png]]
...
![[c1628de0a3b4cdf3a24aa2c4bd8bfd47_MD5.png]]
...
![[af249af1a534d05690c444692a515b52_MD5.png]]
...
你可能记得在[深度测试](http://learnopengl.com/#!Advanced-OpenGL/Depth-testing)教程中，在深度缓冲里的一个值是摄像机视角下，对应于一个片段的一个0到1之间的深度值。**如果我们从光源的透视图来渲染场景，并把深度值的结果储存到纹理中会怎样？通过这种方式，我们就能对光源的透视图所见的最近的深度值进行采样。** 最终，深度值就会显示从光源的透视图下见到的第一个片段了。**我们管储存在纹理中的所有这些深度值，叫做深度贴图（depth map）或阴影贴图。** ![[Pasted image 20220929220626.png]]
...
![[39696458dea52aeef68b6c6e27851c47_MD5.png]]
...
![[8afdf78a701ddad81a76a709003fcf34_MD5.png]]
...
![[6285dbbb075d0c525e84b74771683ea9_MD5.png]]
...
![[4d00f5adcc0e8c1e5cfb2ac08cc38fcc_MD5.png]]
...
![[b6009cee5e0d1daa0be953697f9b6849_MD5.png]]

计算出切线和副切线并不像法线向量那么容易。从图中可以看到法线贴图的切线和副切线与纹理坐标的两个方向对齐。我们就是用到这个特性计算每个表面的切线和副切线的。需要用到一些数学才能得到它们；请看下图：![[312172ee4e46117ba51855417d1557be_MD5.png]]![[Pasted image 20220930202629.png]]
...
![[50e6bf6106228ad3035b3fec454dd1d0_MD5.png]]
...
![[f89a513fc10c90aa475bdc1b01c35b46_MD5.png]]
...
![[a4e8dcc31eeae47e0abbe7cc3d130ae7_MD5.png]]
...
![[7b4683188b78fc78d458fd470a6627b9_MD5.png]]
...
![[f4de35e7d12f732fd87afcdac498b61f_MD5.png]]
...
![[5e2a42ac4c3d14b30c5eb6134a17ea3f_MD5.png]]
...
![[912d224bc1903ea441d2604748e76c5f_MD5.png]]
...
![[e8e16d186ca411c182170d1e9205b4fc_MD5.png]]
...
![[299d971fa42ce31155394e9c46fbce81_MD5.png]]
