...
float4 depthColor = SAMPLE_TEXTURE2D(_CameraDepthTexture, sampler_CameraDepthTexture, screenUV);
float depthbuffer = Linear01Depth(depthColor.g,_ZBufferParams);
