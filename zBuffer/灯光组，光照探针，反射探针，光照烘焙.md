...
一般，最亮的平行光作为主光，剩余的光都加入到了 GetAdditionalLightsCount() 中。
...
//获取灯光组
				   ...
				   //获取当前灯光数据
					   ...
					   //光照叠加 = 兰伯特照明*灯光颜色*灯光衰减*灯光阴影
                       _Color.rgb += max(0, dot(addlight.direction, normalWS) * addlight.color.rgb * addlight.distanceAttenuation * addlight.shadowAttenuation);
...
![[9db26397539e62743fb8820c8029d323_MD5.jpg]]

光照组 Shader

```
Shader "Universal Render Pipeline/CRLuo/CRLuo_URP_14_LightGroup" //URP路径名
{
     //面板属性
    Properties
    {
