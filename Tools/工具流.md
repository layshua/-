...
aliases: []
tags: []
create_time: 2023-04-26 10:24
uid: 202304261024
banner: "![[Pasted image 20230119130436.png]]"
---
# 工具流
笔记：obsidian（笔记）+简悦（剪藏网页）+OneDrive（同步）+ 阿里 codeup/github（备份）+ typora（markdown 默认打开方式）+SimpleTex (截图识别 latex 公式)
...
[赔钱机场 (xn--mes358aby2apfg.com)](https://xn--mes358aby2apfg.com/#/dashboard)
## clash for win
