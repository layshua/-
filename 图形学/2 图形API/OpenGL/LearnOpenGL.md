...
![img](vertex_attribute_pointer_interleaved%201.png)
...
![coordinate_systems_multiple_objects](coordinate_systems_multiple_objects%201.png)
...
![img](v2-739e305622886800faaf952a1df94270_r%201.jpg)
...
![img](v2-97cdb45449dd0e831c22a87b0171e7c1_r%201.jpg)

再利用偏航角y来求一下黄色向量的x、z，也就是图中绿色段和白色段

![img](v2-447cf8767b7623fde4da0696a214eb36_r%201.jpg)

已知偏航角y和刚刚求出来的cosp

所以黄色向量的x=siny*cosp、z=cosy*cosp

![img](v2-b12cc179c00a5d6ca31f6b97c8b91f39_r%201.jpg)
...
![img](basic_lighting_normal_transformation%201.png)
...
>
> ![img](v2-2dbc0e75189c8f9f3a549119939a8723_1440w%201.jpg)
...
![img](basic_lighting_specular_shininess%201.png)
