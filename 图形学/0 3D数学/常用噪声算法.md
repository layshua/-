...
Perlin 本人在梯度噪声基础上，提出过一些优化点 [[1]](https://zhuanlan.zhihu.com/p/346844820#ref_1)：
...
Simplex 噪声是由 Perlin 提出用于优化生成效率的工具 [[2]](https://zhuanlan.zhihu.com/p/346844820#ref_2)。
...
Worley 提出一种流行的程序化方案 [[3]](https://zhuanlan.zhihu.com/p/346844820#ref_3), 将整个平面划分成许多正方形网格 (前面我们一直在用的噪声技巧)，每个网格内随机得到一个特征点。
...
分形噪声被广泛地应用在程序化风景中, 比如模拟山脉, fBM 的自相似性可以很好地模拟山脉形成过程中的不同尺度上的自相似特征 [[4]](https://zhuanlan.zhihu.com/p/346844820#ref_4) 。
